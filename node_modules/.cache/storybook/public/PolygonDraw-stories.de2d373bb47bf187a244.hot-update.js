...
const EdgeConstraintsBar = ({
  ...
  const handleEdgeChange = e => {
    ...
    if (edge === 'none') {
      onSetHorizontal(null); // Set horizontal restriction to null
      onSetVertical(null); // Set vertical restriction to null
      // Set edgeRestrictions to null
      setState({
      ...
      // Set edgeRestrictions to the selected edge
      setState({
        edgeRestrictions: edge
      });
    }
  };
...
//# sourceMappingURL=PolygonDraw-stories.de2d373bb47bf187a244.hot-update.js.map