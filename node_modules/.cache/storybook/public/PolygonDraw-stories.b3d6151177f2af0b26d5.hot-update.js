...
class BaseMap extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  handleMapClick = event => {
    ...
    if (this.state.isDrawToolActive) {
      // Check if a new polygon should be created or an existing one extended
      if (this.props.polygonCoordinates[this.props.activePolygonIndex].length === 0) {
        // Create a new polygon
        const newPolygon = [coordinate];
        this.props.setPolygon([newPolygon]);
      } else {
        // Extend the existing polygon
...
//# sourceMappingURL=PolygonDraw-stories.b3d6151177f2af0b26d5.hot-update.js.map