...
/* harmony import */ var _common_colors__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../common/colors */ "./src/common/colors.tsx");
...
/* harmony import */ var _Icons_Trashcan__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Icons/Trashcan */ "./src/ActionBar/Icons/Trashcan.tsx");
...
const Container = (0,styled_components__WEBPACK_IMPORTED_MODULE_7__["default"])('div')`
    position: relative;
    width: 42px;
    height: 42px;
    ...
    font-size: 10px;
    font-weight: 600;
    color: ${_common_colors__WEBPACK_IMPORTED_MODULE_8__.AUTHENTIC_BLUE_900};
    background-color: ${_common_colors__WEBPACK_IMPORTED_MODULE_8__.WHITE};
    border: solid ${_common_colors__WEBPACK_IMPORTED_MODULE_8__.AUTHENTIC_BLUE_200} 1px;
...
`;
const renderIcon = (icon, inactive, activeIconColor = _common_colors__WEBPACK_IMPORTED_MODULE_8__.ACTION_BLUE_900) => {
  const props = {
    iconColor: inactive ? _common_colors__WEBPACK_IMPORTED_MODULE_8__.AUTHENTIC_BLUE_200 : activeIconColor,
    width: 16,
    height: 16
  };
  switch (icon) {
    case ActionButtonIcons.TRASHCAN:
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Icons_Trashcan__WEBPACK_IMPORTED_MODULE_2__.Trashcan, {
        ...props
      });
    case ActionButtonIcons.FRAME:
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Icons_Frame__WEBPACK_IMPORTED_MODULE_1__.Frame, {
        ...props
      });
    case ActionButtonIcons.VECTOR_MODE:
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Icons_VectorMode__WEBPACK_IMPORTED_MODULE_3__.VectorMode, {
        ...props
      });
    case ActionButtonIcons.EXPORT:
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Icons_Export__WEBPACK_IMPORTED_MODULE_4__.Export, {
        ...props
      });
    case ActionButtonIcons.IMPORT:
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Icons_Import__WEBPACK_IMPORTED_MODULE_5__.Import, {
        ...props
      });
    default:
      return null;
...
/***/ "./src/ActionBar/Icons/Trashcan.tsx":
/*!******************************************!*\
  !*** ./src/ActionBar/Icons/Trashcan.tsx ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
try {
    ...
    Trashcan.displayName = "Trashcan";
    // @ts-ignore
    Trashcan.__docgenInfo = { "description": "", "displayName": "Trashcan", "props": { "iconColor": { "defaultValue": { value: "#001e3e" }, "description": "", "name": "iconColor", "required": false, "type": { "name": "string" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["src/ActionBar/Icons/Trashcan.tsx#Trashcan"] = { docgenInfo: Trashcan.__docgenInfo, name: "Trashcan", path: "src/ActionBar/Icons/Trashcan.tsx#Trashcan" };
}
catch (__react_docgen_typescript_loader_error) { }
...
/* harmony import */ var _leaflet_TileLayer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../leaflet/TileLayer */ "./src/leaflet/TileLayer.tsx");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../constants */ "./src/constants.ts");
/* harmony import */ var _leaflet_Map__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../leaflet/Map */ "./src/leaflet/Map.tsx");
/* harmony import */ var _ActionBar_ActionBar__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../ActionBar/ActionBar */ "./src/ActionBar/ActionBar.tsx");
/* harmony import */ var _EdgeVertex__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./EdgeVertex */ "./src/PolygonDraw/EdgeVertex.tsx");
/* harmony import */ var _PolygonVertex__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./PolygonVertex */ "./src/PolygonDraw/PolygonVertex.tsx");
/* harmony import */ var _BoundaryPolygon__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./BoundaryPolygon */ "./src/PolygonDraw/BoundaryPolygon.tsx");
/* harmony import */ var _Polygon__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Polygon */ "./src/PolygonDraw/Polygon.tsx");
...
class BaseMap extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  reframe = () => {
    ...
    } else if (boundaryPolygonCoordinates.length > 0 && boundaryPolygonCoordinates !== _constants__WEBPACK_IMPORTED_MODULE_8__.MAP.WORLD_COORDINATES) {
  ...
  renderPolygonVertex = (coordinate, index) => {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_PolygonVertex__WEBPACK_IMPORTED_MODULE_12__.PolygonVertex, {
  ...
  renderVertexEdge = (coordinate, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_EdgeVertex__WEBPACK_IMPORTED_MODULE_11__.EdgeVertex, {
    index: index,
    coordinate: coordinate,
  ...
  renderInactivePolygons = () => {
    ...
    return this.props.polygonCoordinates.map((coordinates, index) => {
      ...
      return index === this.props.activePolygonIndex ? null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_Polygon__WEBPACK_IMPORTED_MODULE_14__.Polygon, {
  ...
  renderActivePolygon = () => {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_Polygon__WEBPACK_IMPORTED_MODULE_14__.Polygon, {
      coordinates: coordinates,
      isActive: true,
      isHighlighted: false,
      onClick: () => this.props.onClick && this.props.onClick(index),
  ...
  renderPolyline = () => {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(react_leaflet__WEBPACK_IMPORTED_MODULE_16__.Polyline, {
        positions: polygon,
        color: _constants__WEBPACK_IMPORTED_MODULE_8__.MAP.POLYGON_ACTIVE_COLOR,
        interactive: false
  ...
  renderSelectionRectangle = () => {
    if (this.state.rectangleSelection) {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(react_leaflet__WEBPACK_IMPORTED_MODULE_17__.Rectangle, {
        color: _constants__WEBPACK_IMPORTED_MODULE_8__.MAP.RECTANGLE_SELECTION_COLOR,
        fillColor: _constants__WEBPACK_IMPORTED_MODULE_8__.MAP.RECTANGLE_SELECTION_COLOR,
        bounds: bounds
      });
    }
    return null;
  ...
  render() {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(_leaflet_Map__WEBPACK_IMPORTED_MODULE_9__.Container, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_BoundaryPolygon__WEBPACK_IMPORTED_MODULE_13__.BoundaryPolygon, {
      ...
      }), this.state.rectangleSelection && this.renderSelectionRectangle(), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_leaflet_TileLayer__WEBPACK_IMPORTED_MODULE_7__.TileLayer, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_MapInner__WEBPACK_IMPORTED_MODULE_19__["default"], {
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_ActionBar_ActionBar__WEBPACK_IMPORTED_MODULE_10__.ActionBar, {
        editable: editable,
...
const TileLayer = () => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(react_leaflet__WEBPACK_IMPORTED_MODULE_3__.TileLayer, {
  attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',
  url: _constants__WEBPACK_IMPORTED_MODULE_1__.LEAFLET.TILE_SERVER_URL
});
...
//# sourceMappingURL=PolygonDraw-stories.937047275d3f1091dd97.hot-update.js.map