...
class BaseMap extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  toggleVectorMode = () => {
    ...
    this.setState({
      isPenToolActive: !this.state.isDrawToolActive,
      newPointPosition: null
    });
  };
  toggleDrawMode = () => {
    ...
    this.setState({
      ...
      isDrawToolActive: !this.state.isPenToolActive,
      newPointPosition: null
    });
  };
  getSize = map => {
...
//# sourceMappingURL=PolygonDraw-stories.2f5fbb1b7763025f8971.hot-update.js.map