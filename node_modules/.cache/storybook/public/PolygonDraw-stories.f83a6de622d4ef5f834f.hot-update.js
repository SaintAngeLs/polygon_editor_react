...
class BaseMap extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  handleEdgeClick = (event, index) => {
    const activePolygon = this.props.polygonCoordinates[this.props.activePolygonIndex];
    const startPoint = activePolygon[index];
    const endPoint = activePolygon[(index + 1) % activePolygon.length]; // to wrap around to the first vertex if the last edge is clicked
    const midpoint = (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.getMidPoint)(startPoint, endPoint);
    this.props.addPointToEdge(midpoint, index);
  };
...
//# sourceMappingURL=PolygonDraw-stories.f83a6de622d4ef5f834f.hot-update.js.map