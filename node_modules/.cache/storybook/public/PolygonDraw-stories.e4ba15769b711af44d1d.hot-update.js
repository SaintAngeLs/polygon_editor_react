...
/* harmony import */ var react_leaflet__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! react-leaflet */ "./node_modules/react-leaflet/lib/Polyline.js");
/* harmony import */ var react_leaflet__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! react-leaflet */ "./node_modules/react-leaflet/lib/Rectangle.js");
/* harmony import */ var react_leaflet__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! react-leaflet */ "./node_modules/react-leaflet/lib/Pane.js");
...
/* harmony import */ var _MapInner__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./MapInner */ "./src/PolygonDraw/MapInner.tsx");
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'ActionBar/Icons/IconForHorizontal'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'ActionBar/Icons/IconForVertical'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class BaseMap extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  handleAddVertexInMiddleOfEdge = () => {
    ...
    if (this.state.edgeRestrictions === 'horizontal') {
      ...
      midpoint = (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.getMidPoint)(startPoint, endPoint); // Assuming getMidPoint() returns a Coordinate object with latitude and longitude.
    }
  ...
  renderPolygonVertex = (coordinate, index) => {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_PolygonVertex__WEBPACK_IMPORTED_MODULE_11__.PolygonVertex, {
  ...
  renderVertexEdge = (coordinate, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_EdgeVertex__WEBPACK_IMPORTED_MODULE_10__.EdgeVertex, {
    index: index,
    coordinate: coordinate,
  ...
  renderPolygonEdges = () => {
    return (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.getPolygonEdges)(this.props.polygonCoordinates[this.props.activePolygonIndex]).map((coordinate, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_EdgeVertex__WEBPACK_IMPORTED_MODULE_10__.EdgeVertex, {
      index: index,
      coordinate: coordinate,
      onClick: this.handleEdgeClick,
      edgeRestriction: this.state.edgeRestrictions,
      children: this.state.selectedEdge === index && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("div", {
        children: ["Relationship: ", this.state.edgeRelationships[index], this.state.edgeRelationships[index] === 'horizontal' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'ActionBar/Icons/IconForHorizontal'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {}), this.state.edgeRelationships[index] === 'vertical' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'ActionBar/Icons/IconForVertical'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {})]
      })
    }, index));
  };
  renderInactivePolygons = () => {
    ...
    return this.props.polygonCoordinates.map((coordinates, index) => {
      ...
      return index === this.props.activePolygonIndex ? null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Polygon__WEBPACK_IMPORTED_MODULE_13__.Polygon, {
  ...
  renderActivePolygon = () => {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Polygon__WEBPACK_IMPORTED_MODULE_13__.Polygon, {
      coordinates: coordinates,
      isActive: true,
      isHighlighted: false,
      onClick: () => this.props.onClick && this.props.onClick(index),
  ...
  renderPolyline = () => {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_leaflet__WEBPACK_IMPORTED_MODULE_17__.Polyline, {
        positions: polygon,
        color: _constants__WEBPACK_IMPORTED_MODULE_7__.MAP.POLYGON_ACTIVE_COLOR,
        interactive: false
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_leaflet__WEBPACK_IMPORTED_MODULE_17__.Polyline, {
        positions: newPath,
        color: _constants__WEBPACK_IMPORTED_MODULE_7__.MAP.POLYGON_ACTIVE_COLOR,
        dashArray: "2 12",
        interactive: false
  ...
  renderSelectionRectangle = () => {
    if (this.state.rectangleSelection) {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_leaflet__WEBPACK_IMPORTED_MODULE_18__.Rectangle, {
  ...
  render() {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_leaflet_Map__WEBPACK_IMPORTED_MODULE_8__.Container, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_leaflet_Map__WEBPACK_IMPORTED_MODULE_8__.Map, {
        fadeAnimation: true,
        trackResize: true,
        zoomControl: false,
        ref: this.setMap,
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_BoundaryPolygon__WEBPACK_IMPORTED_MODULE_12__.BoundaryPolygon, {
          coordinates: this.props.boundaryPolygonCoordinates,
          hasError: !this.state.isMovedPointInBoundary
        }), this.props.isPolygonClosed ? this.renderActivePolygon() : this.renderPolyline(), this.renderInactivePolygons(), editable && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(react_leaflet__WEBPACK_IMPORTED_MODULE_19__.Pane, {
          name: "Polygon points",
          children: [this.renderActivePolygonPoints(), this.props.isPolygonClosed && isPenToolActive && this.renderPolygonEdges()]
        }), this.state.rectangleSelection && this.renderSelectionRectangle(), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_MapInner__WEBPACK_IMPORTED_MODULE_20__["default"], {
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_ActionBar_ActionBar__WEBPACK_IMPORTED_MODULE_9__.ActionBar, {
        editable: editable,
        drawable: drawable,
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_ActionBar_EdgeConstraintsBar__WEBPACK_IMPORTED_MODULE_14__.EdgeConstraintsBar, {
        onSetHorizontal: this.handleSetHorizontal,
        onSetVertical: this.handleSetVertical
      }), this.state.showExportPolygonModal && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_common_components_Modal__WEBPACK_IMPORTED_MODULE_4__.Modal, {
        onClose: this.handleExportPolygonModalClosed,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_conversion_ExportPolygonForm__WEBPACK_IMPORTED_MODULE_5__.ExportPolygonForm, {
          polygon: this.props.polygonCoordinates[this.props.activePolygonIndex],
          onSubmit: this.handleExportPolygon
        })
      }), this.state.showImportPolygonModal && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_common_components_Modal__WEBPACK_IMPORTED_MODULE_4__.Modal, {
        onClose: this.handleImportPolygonModalClosed,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_conversion_ImportPolygonForm__WEBPACK_IMPORTED_MODULE_6__.ImportPolygonForm, {
...
//# sourceMappingURL=PolygonDraw-stories.e4ba15769b711af44d1d.hot-update.js.map