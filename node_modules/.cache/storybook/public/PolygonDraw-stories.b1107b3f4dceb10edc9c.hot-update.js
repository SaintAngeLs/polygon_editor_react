...
/* harmony export */   WithInitialCenter: () => (/* binding */ WithInitialCenter),
/* harmony export */   WithInitialZoom: () => (/* binding */ WithInitialZoom),
...
const Highlighted = () => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_src_PolygonDraw_PolygonDraw__WEBPACK_IMPORTED_MODULE_2__.PolygonDraw, {
  editable: false,
  highlightedIndex: 2,
  polygon: SAMPLES,
  boundary: _polygons__WEBPACK_IMPORTED_MODULE_3__.BOUNDARY
...
const WithInitialCenter = {
  render: () => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_src_PolygonDraw_PolygonDraw__WEBPACK_IMPORTED_MODULE_2__.PolygonDraw, {
    editable: false,
    polygon: [],
    initialCenter: {
      longitude: 2.1734,
...
Highlighted.parameters = {
  ...Highlighted.parameters,
  docs: {
    ...Highlighted.parameters?.docs,
    source: {
      originalSource: "() => <PolygonDraw editable={false} highlightedIndex={2} polygon={SAMPLES} boundary={BOUNDARY} />",
      ...Highlighted.parameters?.docs?.source
    }
  }
};
...
WithInitialCenter.parameters = {
  ...WithInitialCenter.parameters,
  docs: {
    ...WithInitialCenter.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => <PolygonDraw editable={false} polygon={[]} initialCenter={{\n    longitude: 2.1734,\n    latitude: 41.3851\n  }} />,\n  name: 'With initial center'\n}",
      ...WithInitialCenter.parameters?.docs?.source
    }
  }
};
WithInitialZoom.parameters = {
  ...WithInitialZoom.parameters,
  docs: {
    ...WithInitialZoom.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => <PolygonDraw editable={false} polygon={[]} initialZoom={6} />,\n  name: 'With initial zoom'\n}",
      ...WithInitialZoom.parameters?.docs?.source
    }
  }
};
const __namedExportsOrder = ["Default", "MultiplePolygons", "New", "NotEditable", "Highlighted", "WithBoundary", "WithInitialCenter", "WithInitialZoom"];
