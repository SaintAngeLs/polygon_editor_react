...
const EdgeConstraintsBar = ({
  ...
  const [isHorizontal, setIsHorizontal] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [isVertical, setIsVertical] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
...
class BaseMap extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  setEdgeConstraint = (edgeIndex, constraintType) => {
    this.setState(prevState => ({
      edgeConstraints: {
        ...prevState.edgeConstraints,
        [edgeIndex]: constraintType
      }
    }));
  };
  removeEdgeConstraint = edgeIndex => {
    this.setState(prevState => {
      const newEdgeConstraints = {
        ...prevState.edgeConstraints
      };
      delete newEdgeConstraints[edgeIndex];
      return {
...
//# sourceMappingURL=PolygonDraw-stories.241bc003a4a6c3143de4.hot-update.js.map